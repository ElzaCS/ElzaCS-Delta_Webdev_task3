...
<center><table width='700px' frame='box' class="tabid" style="position:relative; padding:0;" bgcolor='#b3f0ff'>
   <form class="newstuff" action="form.php" method="post" style="text-align: left;"> 
    ...
    <td> <select name='typ'><option value=''>Select</option><option value="text">Text</option><option value="number">Number</option><option value="image">Image</option><option value="dropdown">Dropdown</option><option value="radio">RadioButton</option></select></td></tr>
...
<?php if ($_POST['typ']=="dropdown" || $_POST['typ']=="radio") { 
 ...
 echo "<td><input type='text' placeholder='enter label(single word, no spaces)' name='op1' style='width:100%;' required></td></tr>";
echo "<tr><td><label><b>Option2 Label</b></label></td>";
 echo "<td><input type='text' placeholder='enter label(single word, no spaces)' name='op2' style='width:100%;'></td></tr>";
echo "<tr><td><label><b>Option3 Label</b></label></td>";
 echo "<td><input type='text' placeholder='enter label(single word, no spaces)' name='op3' style='width:100%;'></td></tr>";
echo "<tr><td><label><b>Option4 Label</b></label></td>";
 echo "<td><input type='text' placeholder='enter label(single word, no spaces)' name='op4' style='width:100%;'></td></tr>";
}?>
 <tr><td colspan='2'><center><button type="submit" name="numsubmitbtn" style="height:40px;width:235px">Add Field</button></center></td></tr>
   </form>
<?php } ?>
...
//sql to add dropdown fields to form
...
//sql to add radio fields to form
...
if ($rowN['name1']!=null) echo "<input type='radio' name='".$rowN['field_name']."' value='".$rowN['name1']."' checked>".$rowN['name1'];
...
echo "</td></tr>";
    ...
    echo "<td><input type=".$rowN['field_type']." style='width:100%'></input></td>";
  }
...
?>
<br><center><button onclick="document.getElementById('id14').style.display='block'" style="height:50px;width:235px;float:center;">Set Deadline</button></center>
<!-- Add Deadline -->
...
<br><center><button onclick="document.getElementById('id04').style.display='block'" style="height:50px;width:235px;float:center;">Save Form & Get Link</button></center>
<!-- Save Form & Get Link -->
